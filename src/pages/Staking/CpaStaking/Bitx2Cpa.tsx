...
import {
  BTX2CPA_CONTRACT_ADDRESS,
  BTX2CPA_CONTRACT_ABI,
  BTX2CPA_CONTRACT_NAME,
  BTX_TOKEN_TICKER,
  BTX_TOKEN_ID,
  BTX_TOKEN_DECIMALS,
  CPA_TOKEN_DECIMALS,
...
const Bitx2Cpa = () => {
  ...
  React.useEffect(() => {
    (async () => {
      ...
      //     urls: [BTX2CPA_CONTRACT_ABI],
      // });
      // const contract = new SmartContract({
      //     address: new Address(BTX2CPA_CONTRACT_ADDRESS),
      //     abi: new SmartContractAbi(abiRegistry, [BTX2CPA_CONTRACT_NAME]),
      // });
      // setStakingContract(contract);

      const registry = await AbiRegistry.load({ urls: [BTX2CPA_CONTRACT_ABI] });
      const abi = new SmartContractAbi(registry, [BTX2CPA_CONTRACT_NAME]);
      const contract = new SmartContract({ address: new Address(BTX2CPA_CONTRACT_ADDRESS), abi: abi });
  ...
  async function stake(e: any) {
    ...
    const tx = {
      receiver: BTX2CPA_CONTRACT_ADDRESS,
