...
import {
  ...
  LPAD2LPAD_CONTRACT_ABI,
  LPAD2LPAD_CONTRACT_NAME,
  LPAD_TOKEN_TICKER,
  LPAD_TOKEN_ID,
  LPAD_TOKEN_DECIMALS,
    ...
    <div className='card'>
      ...
      <div className='info' style={{ marginTop: "8px" }}>
        ...
        <div>
          ...
          <p className='data'>{stakeSetting ? stakeSetting.total_staked_amount : '-'} {LPAD_TOKEN_TICKER}</p>
        </div>
        <div>
      ...
      <div className='info'>
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.staked_amount : '-'} LPAD</p>
        </div>
        <div>
          <p className='heading'>My Unstaked</p>
          <p className='data'>{stakeAccount ? stakeAccount.unstaked_amount : '-'} LPAD</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.collectable_amount : '-'} LPAD</p>
        </div>
      </div>
