...
import {
  BTX2LPAD_CONTRACT_ADDRESS,
  BTX2LPAD_CONTRACT_ABI,
  BTX2LPAD_CONTRACT_NAME,
  BTX_TOKEN_TICKER,
  BTX_TOKEN_ID,
  BTX_TOKEN_DECIMALS,
  LPAD_TOKEN_DECIMALS,
...
const Bitx2Lpad = () => {
  ...
  React.useEffect(() => {
    (async () => {
      ...
      //     urls: [BTX2LPAD_CONTRACT_ABI],
      // });
      // const contract = new SmartContract({
      //     address: new Address(BTX2LPAD_CONTRACT_ADDRESS),
      //     abi: new SmartContractAbi(abiRegistry, [BTX2LPAD_CONTRACT_NAME]),
      // });
      // setStakingContract(contract);

      const registry = await AbiRegistry.load({ urls: [BTX2LPAD_CONTRACT_ABI] });
      const abi = new SmartContractAbi(registry, [BTX2LPAD_CONTRACT_NAME]);
      const contract = new SmartContract({ address: new Address(BTX2LPAD_CONTRACT_ADDRESS), abi: abi });
  ...
  async function stake(e: any) {
    ...
    const tx = {
      receiver: BTX2LPAD_CONTRACT_ADDRESS,
    ...
    <div className='card'>
      ...
      <div className='info'>
        ...
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.reward_amount : '-'} LPAD</p>
        </div>
        <div>
